...
<div class="container mx-auto mt-10">
    <div class="max-w-md mx-auto bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-900 text-xl font-semibold text-white">{{ __('Confirm Password') }}</div>
        ...
        <div class="px-6 py-4">
            ...
            <form method="POST" action="{{ route('password.confirm') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="password" type="password" class="form-input w-full mt-2 px-3 py-2 rounded-lg bg-gray-700 text-gray-100 border border-gray-600 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('password') border-red-500 @enderror" name="password" required autocomplete="current-password">
                ...
                <div class="mb-0">
                    <button type="submit" class="w-full bg-indigo-500 text-white rounded-lg px-4 py-2 font-semibold hover:bg-indigo-600 focus:outline-none focus:border-indigo-700 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        {{ __('Confirm Password') }}
                    </button>

                    @if (Route::has('password.request'))
                        <a class="block text-center mt-2 text-indigo-400 hover:text-indigo-600" href="{{ route('password.request') }}">
